...
function Footer() {
  return (
    <footer className="footer mt-auto pt-5 pb-2">
      <Navbar className="footer-navbar-elements footer">
        <Container className="footer-container">
          <div class="inline-block justify-content-center">
            <Row className="mx-auto text-center">
              <Col className="hr-falla">
                ...
                <LinkContainer to="/">
                  <Navbar.Brand>
                    <div class="brand-name">
                      <span class="first-part">Fala</span>
                      <span class="second-part">fellas</span>
                    </div>
                  </Navbar.Brand>
                </LinkContainer>
              </Col>
              ...
              <div className="copyright-tag">
                ...
                <span>
                  <p className="copyright-font">
                    2024 Falafellas. All rights reserved.
                  </p>
                </span>
              </div>
            </Row>
