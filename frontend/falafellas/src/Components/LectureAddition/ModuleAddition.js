...
function ModuleAddition() {
  ...
  return (
    <div className="App">
      ...
      <Form.Group>
        <Form.Control size="lg" type="text" placeholder="Course Name" className="w-75" style={{ margin: '20px' }} />
      </Form.Group>
      <div style={{ marginLeft: '20px', marginTop: '20px' }}>
        <Row style={{ marginRight: '0px' }}>
          <Col>
            <AccordionElement modules={modules} addModule={addModule} onClickItem={onClickItem} />
          </Col>
          <Col>
